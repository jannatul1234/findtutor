...
@include('fontend.inc.banner')
    ...
    <div class="middlesection-w3pvt py-sm-5 pt-sm-0 pt-5 mt-5" id="stats">
        ...
        <div class="property-paper">
            <img src="{{asset('/lib/')}}/images/img3.png" alt="" class="img-fluid agents-w3" />
        </div>
    </div>
    <!-- //stats section -->
        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal1"><img src="{{asset('/lib/')}}/images/g1.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal2"><img src="{{asset('/lib/')}}/images/g2.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal3"><img src="{{asset('/lib/')}}/images/g3.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal4"><img src="{{asset('/lib/')}}/images/g4.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal5"><img src="{{asset('/lib/')}}/images/g5.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal6"><img src="{{asset('/lib/')}}/images/g6.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal7"><img src="{{asset('/lib/')}}/images/g7.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal8"><img src="{{asset('/lib/')}}/images/g8.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal9"><img src="{{asset('/lib/')}}/images/g9.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <!-- gallery popups -->
            <!-- popup-->
            <div id="gal1" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g1.jpg" alt="Popup Image" class="img-fluid" />
            ...
            <div id="gal2" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g2.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal3" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g3.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal4" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g4.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal5" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g5.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal6" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g6.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal7" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g7.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal8" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g8.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal9" class="pop-overlay animate">
                <div class="popup">
                    <img src="{{asset('/lib/')}}/images/g9.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
    ...
    <section class="clients py-5" id="testi">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="feedback-info text-center">
                ...
                <img src="{{asset('/lib/')}}/images/te1.jpg" alt=" " class="img-fluid mt-5">
