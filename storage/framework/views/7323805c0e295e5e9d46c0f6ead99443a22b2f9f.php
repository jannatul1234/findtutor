        ...
        <div class="col-md-8 mt-5 mb-5">
            <div class="card mt-5 ">
                <div class="row offset-md-5">
                   ...
                   <a href="<?php echo e(url('/register')); ?>"><button type="button" class="btn btn-primary ">Student</button></a> 
                <a href="<?php echo e(url('/teacher')); ?>"><button type="button" class="btn btn-success ml-3">Teacher</button></a> 
...
unset($__errorArgs, $__bag); ?>" name="class" value="<?php echo e(old('class')); ?>"  autocomplete="class1" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="city" value="<?php echo e(old('city')); ?>"  autocomplete="city">
...
unset($__errorArgs, $__bag); ?>" name="parent_name" value="<?php echo e(old('parent_name')); ?>"  autocomplete="parent_name">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-dark text-md-right"><?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-dark text-md-right"><?php echo e(__('Confirm Password')); ?></label>
...
<input type="hidden" name="type" value="student">
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                </button> <a class="ml-2" href="<?php echo e(url('/login')); ?>">Already have an account?</a> 
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('fontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamp\htdocs\student\resources\views/auth/register.blade.php ENDPATH**/ ?>