...
<div class="form-group row">
                            <label for="subject" class="col-md-4 col-form-label text-dark text-md-right"><?php echo e(__('Subject')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="subject" value="<?php echo e(Auth::user()->subject); ?>" required autocomplete="subject" autofocus>
...
<?php echo $__env->make('fontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamp\htdocs\student\resources\views/auth/editteacher.blade.php ENDPATH**/ ?>