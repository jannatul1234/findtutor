...
<?php echo $__env->make('fontend.inc.banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="offset-lg-4 offset-sm-3 left-build-wthree aboutright-w3pvtwthree">
                ...
                <div class="row">
                    ...
                    <div class="col-4 w3layouts_stats_left w3_counter_grid2">
                        ...
                        <p class="para-text-w3ls text-li let">Total Student</p>
                    </div>
                    <div class="col-4 w3layouts_stats_left w3_counter_grid1">
                        <h4 class="counter">30</h4>
                        <p class="para-text-w3ls text-li let">Appointed</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="property-paper">
            <img src="<?php echo e(asset('/lib/')); ?>/images/img3.png" alt="" class="img-fluid agents-w3" />
        </div>
    </div>
    <!-- //stats section -->
        ...
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal1"><img src="<?php echo e(asset('/lib/')); ?>/images/g1.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal2"><img src="<?php echo e(asset('/lib/')); ?>/images/g2.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal3"><img src="<?php echo e(asset('/lib/')); ?>/images/g3.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal4"><img src="<?php echo e(asset('/lib/')); ?>/images/g4.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal5"><img src="<?php echo e(asset('/lib/')); ?>/images/g5.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal6"><img src="<?php echo e(asset('/lib/')); ?>/images/g6.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <div class="row news-grids text-center no-gutters">
                <div class="col-md-4 gal-img">
                    <a href="#gal7"><img src="<?php echo e(asset('/lib/')); ?>/images/g7.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal8"><img src="<?php echo e(asset('/lib/')); ?>/images/g8.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
                <div class="col-md-4 gal-img">
                    <a href="#gal9"><img src="<?php echo e(asset('/lib/')); ?>/images/g9.jpg" alt="Gallery Image" class="img-fluid"></a>
                </div>
            </div>
            <!-- gallery popups -->
            <!-- popup-->
            <div id="gal1" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g1.jpg" alt="Popup Image" class="img-fluid" />
            ...
            <div id="gal2" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g2.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal3" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g3.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal4" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g4.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal5" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g5.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal6" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g6.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal7" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g7.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal8" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g8.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
            ...
            <div id="gal9" class="pop-overlay animate">
                <div class="popup">
                    <img src="<?php echo e(asset('/lib/')); ?>/images/g9.jpg" alt="Popup Image" class="img-fluid" />
                    <p class="mt-4">Nulla viverra pharetra se, eget pulvinar neque pharetra ac int. placerat placerat
                        dolor.</p>
                    <a class="close" href="#gallery">&times;</a>
                </div>
    ...
    <section class="clients py-5" id="testi">
        <div class="container py-xl-5 py-lg-3">
            ...
            <div class="feedback-info text-center">
                ...
                <img src="<?php echo e(asset('/lib/')); ?>/images/te1.jpg" alt=" " class="img-fluid mt-5">
...
<?php echo $__env->make('fontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamp\htdocs\student\resources\views/fontend/home/home.blade.php ENDPATH**/ ?>